...
--
-- Host: localhost
-- Generation Time: Nov 29, 2021 at 02:45 AM
...
(12, 21, 2, 19, 1, 1, 0, 0, 0, 0, 0, 0, 1),
(13, 24, 2, 27, 1, 1, 0, 0, 0, 0, 0, 0, 1),
...
--
ALTER TABLE `event_type`
  MODIFY `Event_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
